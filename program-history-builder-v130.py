#!/usr/bin/env python3
"""BOAT COMMAND · PROGRAM HISTORY BUILDER v1.3.0
...
VERSION = "PROGRAM-HISTORY-BUILDER-V1.3.0"
...
RACE_HEAD = re.compile(r"^\s*(\d{1,2})\s*R\s*(.*?)\s+H\s*\d{3,4}(?:m)?\b", re.I)
...
def self_test() -> None:
    ...
    # Distance-shortening regression: official programs may switch from H1800m to H1200m.
    short_b = """蒲　郡［番組］ 2025/05/09\n １１Ｒ 一般特選 Ｈ1200m 電話投票締切予定20:04\n1 4171榎 幸司37長崎51A2 6.36\n2 3305小野信樹52岡山53B1 4.06\n3 4874池田奈津26福岡51B1 4.75\n4 3507藤井 徹49大阪52B1 4.08\n5 5146野田彩加17山口49B2 1.28\n6 4034西原明生41香川54A1 4.55\n"""
    sb = venue_blocks(short_b, "B")["07"]
    sp = parse_program_block(sb)
    assert sp[11].classes == ("A2", "B1", "B1", "B1", "B2", "A1")
    assert sp[11].race_type == "一般特選"
    print("SELF-TEST PASS · legacy + real-format + H1200 distance-shortening parser")
