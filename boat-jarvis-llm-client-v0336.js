...
async function chat(text,context={}){const q=String(text||'').normalize('NFKC').trim();if(!q)return'';
  ...
  const body={message:q,state:context,history};
...
window.BOAT_JARVIS_LLM_CLIENT_V0336=Object.freeze({version:VERSION,chat,clearConversationState:clear,previousResponseId:previous,endpoint:ENDPOINT,clientApiKey:false,responseContinuity:true});
})();