// BOAT COMMAND GAMAGORI VISUAL AI CORE v0.30.0
// Free UI layer only. Reads existing session/voice state and never mutates race data.
(()=>{
'use strict';
const VERSION='GAMAGORI-VISUAL-AI-CORE-V0.30.0';
let pulseTimer=null;
