// BOAT COMMAND GLOBAL VISUAL AI CORE v0.31.1
// Free command-center UI. Reads state and delegates safe operations to existing app controls.
(()=>{
'use strict';
const VERSION='BOAT-COMMAND-VISUAL-AI-CORE-V0.31.1';
let pulseTimer=null;
