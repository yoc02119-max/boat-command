...
function allSettled(){return sessions().flatMap(settled)}
...
function render(){renderHeadBoat();renderWinners();renderMode();renderHistory()}
...
window.BOAT_COMMAND_LIVE_PERFORMANCE_V0323=Object.freeze({version:VERSION,render,readOnly:true,fetchesResults:false,fetchesPreRace:false});
