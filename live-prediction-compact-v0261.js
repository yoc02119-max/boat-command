// BOAT COMMAND GAMAGORI LIVE PREDICTION COMPACT UI v0.27.1
// LIVE prediction screen: first/second predictions + HARD LOCK + prediction/app-version refresh.
// Safety visibility v0.27.1: compact mode must never hide explicit LIVE WAIT/SKIP fail-closed gates.
(()=>{
'use strict';
const VERSION='GAMAGORI-LIVE-COMPACT-V0.27.1';
