...
async function serverContract(){
  process.env.BOAT_COMMAND_ALLOWED_ORIGIN='https://yoc02119-max.github.io';process.env.BOAT_COMMAND_ACCESS_TOKEN='private-access';process.env.VERCEL_OIDC_TOKEN='vercel-oidc';process.env.JARVIS_GITHUB_EXECUTOR_TOKEN='server-only-github';
  ...
  }finally{global.fetch=original;for(const key of['BOAT_COMMAND_ALLOWED_ORIGIN','BOAT_COMMAND_ACCESS_TOKEN','VERCEL_OIDC_TOKEN','JARVIS_GITHUB_EXECUTOR_TOKEN'])delete process.env[key]}
}
