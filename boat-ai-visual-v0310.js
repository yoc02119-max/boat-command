// BOAT COMMAND GLOBAL VISUAL AI CORE v0.31.0
// Free command-center UI. Reads state and delegates safe operations to existing app controls.
(()=>{
'use strict';
const VERSION='BOAT-COMMAND-VISUAL-AI-CORE-V0.31.0';
let pulseTimer=null;
...
function install(){
  ...
  core.innerHTML=`<div class="bc-core-top"><div class="bc-core-title"><small>BOAT COMMAND · SYSTEM CORE</small><strong>AI CORE</strong></div><div class="bc-core-online"><i></i>COMMAND CORE ONLINE</div></div><div class="bc-core-stage"><div class="bc-orb-wrap" aria-hidden="true"><div class="bc-ring r1"></div><div class="bc-ring r2"></div><div class="bc-ring r3"></div><div class="bc-orbit-dot"></div><div class="bc-orb"></div></div><div class="bc-core-caption"><strong data-core-state>待機中</strong><span data-core-line>BOAT COMMAND全体を監視しています</span></div></div><div class="bc-core-stats"><div class="bc-core-stat"><span>蒲郡 第一候補</span><b data-core-stat="first">0/12</b></div><div class="bc-core-stat"><span>蒲郡 第二候補</span><b data-core-stat="second">0/12</b></div><div class="bc-core-stat"><span>HARD LOCK</span><b data-core-stat="locked">0/12</b></div><div class="bc-core-stat"><span>精算</span><b data-core-stat="settled">0/12</b></div></div><div class="bc-core-actions"><button type="button" data-core-action="talk">🎙 AIと話す</button><button type="button" data-core-action="refresh">最新同期</button><button type="button" data-core-action="connect">ChatGPT接続</button></div><div class="bc-core-control"><span>APP CONTROL</span><div class="bc-core-nav"><button type="button" data-core-view="home">蒲郡</button><button type="button" data-core-view="predict">12R予想</button><button type="button" data-core-view="results">精算</button><button type="button" data-core-view="analytics">分析</button><button type="button" data-core-view="data">DATA</button></div></div>`;
...
window.BOAT_COMMAND_VISUAL_AI_CORE=Object.freeze({version:VERSION,free:true,commandCenter:true,protectedMutations:true,setState,renderStats,openView});
