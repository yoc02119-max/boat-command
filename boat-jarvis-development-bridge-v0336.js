...
// Produces and dispatches machine-readable development jobs to the authorized GitHub execution layer.
(()=>{
'use strict';
...
function pending(){return read().filter(x=>['QUEUED','DISPATCHING','QUEUED_REMOTE'].includes(x.status))}
window.BOAT_JARVIS_DEVELOPMENT_BRIDGE_V0336=Object.freeze({version:VERSION,enqueue,dispatch,latest,pending,mark,target:'CODEX_GITHUB',opensExternalPage:false,remoteDispatch:true});
})();
