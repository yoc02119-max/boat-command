#!/usr/bin/env python3
"""BOAT COMMAND · PROGRAM HISTORY BUILDER v1.3.1
...
VERSION = "PROGRAM-HISTORY-BUILDER-V1.3.1"
...
RACE_HEAD = re.compile(r"^\s*(\d{1,2})\s*R\s*(.*?)\s+H\s*\d{3,4}(?:m)?", re.I)
